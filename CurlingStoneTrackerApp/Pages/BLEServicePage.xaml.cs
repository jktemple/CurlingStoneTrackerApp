...
namespace CurlingStoneTrackerApp
{
	...
	public partial class BLEServicePage : ContentPage
	{
        ...
        public BLEServicePage(IDevice connectedDevice)
		{
			InitializeComponent();
        ...
        private async void FoundBleServs_ItemTapped(object sender, ItemTappedEventArgs e)       // Function that is called when someone selects a Service interface to see the Characteristics of that interface
        {
            ...
            {
                await Navigation.PushAsync(new BLECharacteristicPage(_connectedDevice, selectedService));  // Navigate to the Characteristics site
            }
        }
    }
}
